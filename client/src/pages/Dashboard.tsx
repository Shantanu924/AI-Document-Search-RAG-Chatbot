...
import { Plus, Calendar, MoreVertical, Edit, Trash2, FileText, Globe, User } from "lucide-react";
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold font-display text-foreground">
            {activeTab === "my-posts" ? "My Workspace" : "Community Feed"}
          </h1>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full max-w-md grid-cols-2 mb-8 h-12 p-1 bg-muted/50 rounded-xl">
          <TabsTrigger value="feed" className="rounded-lg gap-2">
            <Globe className="w-4 h-4" />
            Community Feed
          </TabsTrigger>
          <TabsTrigger value="my-posts" className="rounded-lg gap-2">
